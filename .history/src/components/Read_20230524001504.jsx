...
const Read = () => {
    ...
    return (
       ...
       { showPop && <ViewUser id={id}  setShow={setShowPop}/> }
        ...
        <input className='form-check-input' name="gender" value="all" onChange={(e)=>setGenderData(e.target.value)} type='radio' checked={genderData===""}/>
        ...
        <input className='form-check-input' name="gender" vlaue="female" onChange={(e)=>setGenderData(e.target.value)} type='radio' checked={genderData==="female"}/>
