...
const Read = () => {
    ...
    return (
        <>
        { showUpdate && <UpdateUser id={id} setUpdate={setShowUpdate} /> }
        ...
        <div >
        {
             userData && userData.map((data)=>(
                ...
                <div className="card-body">
                    ...
                    <button  className="card-link" onClick={()=>{setUpId(data.id),setShowUpdate(true),dispatch(updateUser(data.id))}} >Edit</button>
