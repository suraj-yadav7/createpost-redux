...
const Read = () => {
    ...
    return (
       ...
       { showPop && <ViewUser id={id}  setShow={setShowPop}/> }
        ...
        <input className='form-check-input' name="gender" value="all" onChange={(e)=>{setGenderData(e.target.value),dispatch(genderShow(genderData))}} type='radio' checked={ genderData === "all"}/>
        <lable className="form-check-label">All</lable> 
        <input className='form-check-input' name="gender" value="male" onChange={(e)=>{setGenderData(e.target.value),dispatch(genderShow(genderData))}} type='radio' checked={genderData==="male"}/>
        <lable className="form-check-label">Male</lable> 
        <input className='form-check-input' name="gender" value="female" onChange={(e)=>{setGenderData(e.target.value),dispatch(genderShow(genderData))}} type='radio' checked={genderData==="female"}/>
