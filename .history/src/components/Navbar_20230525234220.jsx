      ...
      <nav className="navbar navbar-expand-lg bg-body-tertiary">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button style={{padding:"0 1rem", margin:"0 1rem"}} onClick={() => loginWithRedirect()}>Log In</button>
            <button style={{padding:"0 1rem", margin:"0 1rem"}}  onClick={()=> logout({ logoutParams: { returnTo: window.location.origin } })}> Log out</button>
            </div>
          </div>
        </div>
      </nav>
