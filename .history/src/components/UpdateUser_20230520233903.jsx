...
const Update = ({id,setUpdate})=>{
    ...
    return(
        ...
        <div className="update">
            ...
            <span>Name: </span><input type="text" onChange={updateChange}  value={singleUserData.name}></input>
            <span>Email:</span><input type="text"onChange={updateChange} value={singleUserData.email}></input>
            <span>Age(digit): </span> <input type="number" value={singleUserData.age}></input>
