...
import { showUser,update } from '../store/slice/userDetail';
...
const Read = () => {
    ...
    //    let userdata= userData.filter((elem)=>elem.id !== id)
            // dispatch((update(userdata)))
            let removeData = userData.findIndex((elem)=> elem.id===id)
            let data1 = userData.splice(removeData,1)
            console.log("the removed data with splice", removeData)
  }
