...
const Read = () => {
    ...
    return (
       ...
       { showPop && <ViewUser id={id}  setShow={setShowPop}/> }
        ...
        <input className='form-check-input' name="favourite" value="userFav" onChange={(e)=>{setGenderData(e.target.value),setFav(true),handleFav()}} type='radio' checked={genderData==="userFav"}/>
        ...
        </div>
        {
             ...
             .map((data)=>(
                ...
                <div className="card-body">
                    ...
                    <button className='card-link' onClick={()=> dispatch(favouriteUser(data))} >favourite</button>
                </div>
                </div>
               ))
        }
