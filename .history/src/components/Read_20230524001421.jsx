...
const Read = () => {
    ...
    return (
       ...
       { showPop && <ViewUser id={id}  setShow={setShowPop}/> }
        ...
        <input className='form-check-input' name="gender" value="all" onChange={()=>setGenderData(e.targe.value)} type='radio' checked={genderData===""}/>
        <lable className="form-check-label">All</lable> 
        <input className='form-check-input' name="gender" value="male" onChange={()=>setGenderData(e.targe.value)} type='radio' checked={genderData==="male"}/>
        <lable className="form-check-label">Male</lable> 
        <input className='form-check-input' name="gender" vlaue="female" onChange={()=>setGenderData(e.targe.value)} type='radio' checked={genderData==="female"}/>
