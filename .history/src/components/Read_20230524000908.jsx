...
const Read = () => {
    ...
    const handleGender = (e) =>{
        setGenderData({...genderData, [e.target.name]:e.target.value})
    ...
    return (
       ...
       { showPop && <ViewUser id={id}  setShow={setShowPop}/> }
        ...
        <input className='form-check-input' name="gender" value="all" onChange={handleGender} type='radio' checked/>
        <lable className="form-check-label">All</lable> 
        <input className='form-check-input' name="gender" value="male"onChange={handleGender} type='radio'/>
        <lable className="form-check-label">Male</lable> 
        <input className='form-check-input' name="gender" vlaue="female" onChange={handleGender} type='radio'/>
